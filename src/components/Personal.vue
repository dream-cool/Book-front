              ...
              <el-form-item label="头像">
                    <el-upload
                      ...
                      <div class="el-upload__tip" slot="tip">只支持jpg/png/jpeg文件</div>
                        ...
                        :size="150"  :src='(beforeUser.avatar != null && beforeUser.avatar.substring(0, 7) == "http://" ) ? beforeUser.avatar : server_URL+"/download/"+beforeUser.avatar' style="float:left">{{beforeUser.userName}}</el-avatar>
                    </el-upload>
              </el-form-item>
